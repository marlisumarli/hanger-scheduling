...
<?php endif; ?>
    ...
    <form action="" method="post">
        ...
        <input type="date" name="dateUpdate" id="dateUpdate"
               value="<?php echo e($model['idSupply']->getSupplyDate()); ?>">
        <br>
...
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\subjig-management-pt-indospray\app\View/Admin/Supply/Hanger/K2F/update.blade.php ENDPATH**/ ?>