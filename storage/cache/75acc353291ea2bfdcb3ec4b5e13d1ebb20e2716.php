    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="/admin/supply/<?php echo e($model["type"]); ?>/<?php echo e($model["schedule"]); ?>/<?php echo e($model["supplyId"]); ?>/view"><?php echo e($dateTime->format('d/m/Y')); ?></a>
            </li>
            <li aria-current="page" class="breadcrumb-item active">Ubah Laporan</li>
        </ol>
    </nav>
    <div class="mb-4">
        <h1>Update Laporan Supply <?php echo e(strtoupper($model["type"])); ?></h1>
    </div>
                ...
                <div class="card rounded-3 shadow-lg">
                    <div class="card-body">
                        ...
                        <input class="form-control" id="targetSet" min="100" name="target" required type="number"
                               value="<?php echo e($model['supply']->getTargetSet()); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md">
                <?php $__currentLoopData = $model['hangers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hanger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card shadow-lg rounded-3 mb-2">
                        ...
                        <div class="card-body">
                            <div class="row g-1">
                                <?php $__currentLoopData = $model['supply_lines']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplyLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                    <?php if($supplyLine->getHangerId() == $hanger->getId() && $supplyLine->getSupplyId() == $model['supply']->getId()): ?>
                                        <div class="col-4">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="/admin/supply/<?php echo e($model["type"]); ?>/<?php echo e($model["schedule"]); ?>/<?php echo e($model["supplyId"]); ?>/view"
...
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/ScheduleSupply/Supply/Hanger/update.blade.php ENDPATH**/ ?>