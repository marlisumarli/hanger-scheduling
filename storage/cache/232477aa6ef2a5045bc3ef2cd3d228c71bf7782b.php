...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-4">
        <h1>Buat Laporan Supply <?php echo e(strtoupper($type)); ?></h1>
    </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <span>Tanggal dibuat</span><span
                                    class="badge text-bg-warning"><?php echo e($schedule_week->getDate()); ?></span>
                        </div>
            ...
            <div class="col-md">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <a href="/admin/supply/<?php echo e($type); ?>" class="btn btn-secondary rounded-3 mt-3 shadow-lg">Kembali</a>
                </div>
            </div>
        </div>
    </form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/Supply/create.blade.php ENDPATH**/ ?>