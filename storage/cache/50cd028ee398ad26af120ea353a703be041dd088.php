    ...
    <div class="sidebar bg-light shadow">
        ...
        <div class="sidebar-body">
            <ul class="navigation-list">
                ...
                <li class="navigation-list-item">
                    <a href="/admin/list-item" class="navigation-link <?php echo e($model['listItem'] ?? ''); ?>">
                        <div class="row p-1 px-3 mb-2">
                            <div class="col-2">
...
<?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/Partial/navbar.blade.php ENDPATH**/ ?>