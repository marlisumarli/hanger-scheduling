        ...
        <div class="card rounded-3 shadow-lg">
            <div class="card-header">
                <div class="card-title">
                    <span>Update User #<b><?php echo e($user->getUserName()); ?></b></span>
                </div>
            </div>

            <div class="card-body">
                <form action="/admin/user/<?php echo e($user->getUsername()); ?>/update" method="post"
                      class="form-floating d-flex mb-3">
                    <input class="form-control" id="floatingUpdateName" placeholder="Name" required
                           type="text" value="<?php echo e($user->getFullName()); ?>" name="name">
                ...
                <form action="/admin/user/<?php echo e($user->getUsername()); ?>/update" method="post" class="d-flex">
                    <select aria-label="Default select example" class="form-select" required name="role">
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($user->getRoleId() == $role->getId()): ?>
                                <option value="<?php echo e($user->getRoleId()); ?>"
