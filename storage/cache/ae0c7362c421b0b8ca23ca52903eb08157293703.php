...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($model['find_id'] != null): ?>
        ...
        <div class="row d-flex justify-content-center">
                ...
                <ul class="list-group">
                    <li class="list-group-item list-group-item-secondary d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <span class="fw-bold">Type : <?php echo e(strtoupper($model['find_id']->getId())); ?></span>
                        </div>
                    ...
                    <li class="list-group-item list-group-item-secondary d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <span class="fw-bold">Jumlah Item : <?php echo e($model['find_id']->getQty()); ?></span>
                        </div>
                        <button class="btn btn-sm rounded bg-warning py-1 ms-auto shadow-lg"
                                data-bs-placement="top"
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8 mb-3">
                <form class="card rounded-3 shadow-lg"
                      action="/admin/item/<?php echo e($model['find_id']->getId()); ?>/hanger/register" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($i < count($model['hangers'])): ?>
                                            <a class="link-danger"
                                               href="/admin/item/<?php echo e($model['hangers'][$i]->getHangerTypeId()); ?>/<?php echo e($model['hangers'][$i]->getId()); ?>/delete"
        ...
        <div aria-hidden="true" aria-labelledby="updateTypeLabel" class="modal fade"
            ...
            <form action="/admin/item/<?php echo e($model['find_id']->getId()); ?>/update" method="post" class="modal-dialog">
