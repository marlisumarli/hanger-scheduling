...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-4">
        <h1>Laporan Supply <u><?php echo e(strtoupper($model["type"])); ?></u> Bulan
    ...
    <?php $__currentLoopData = $model['schedule_weeks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheduleWeek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <?php if((INT)$scheduleWeek->getIsDone() != 0): ?>
...
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/ScheduleSupply/Supply/data-report.blade.php ENDPATH**/ ?>