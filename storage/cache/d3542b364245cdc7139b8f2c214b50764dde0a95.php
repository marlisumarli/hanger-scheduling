...
<?php $__env->startSection('content'); ?>
    <form action="" method="post">
        ...
        <select id="category" name="category" class="" aria-label="Category">
            <?php $__currentLoopData = $supply['allCategory']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <br>
        <?php $__currentLoopData = $supply['allK2f']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
