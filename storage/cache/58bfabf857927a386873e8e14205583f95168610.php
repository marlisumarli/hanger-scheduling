...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mb-2">
        <div class="card-header d-flex">
            ...
            <div class="ms-auto">
                <span>Target #<?php echo e($model['supply']->getTargetSet()); ?> set</span>
            </div>
        </div>
                    ...
                    <tr class="c-border">
                        <?php $__currentLoopData = $model['supply_lines']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supply_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($supply_line->getHangerId() == $hanger->getId()): ?>
                                ...
                                <td><?php echo e(ceil($model['supply']->getTargetSet()/$hanger->getQty())); ?></td>
        ...
        <div class="card-footer d-flex">
            <div class="ms-auto">
                <a class="btn btn-warning btn-sm py-0"
                   href="/admin/supply/<?php echo e($model['type']); ?>/<?php echo e($model['schedule']); ?>/<?php echo e($model['supplyId']); ?>/update">
...
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/ScheduleSupply/Supply/Hanger/view.blade.php ENDPATH**/ ?>