            ...
            <div class="container col-md-3 mb-3">
                <div class="card rounded-3 shadow-lg">
                    ...
                    <div class="card-footer text-center">
                        <a class="small stretched-link" href="/admin/supply/<?php echo e($hanger_type->getId()); ?>">
...
<?php echo $__env->make('Admin/Layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hanger-management-pt-indospray\app\View/Admin/Supply/index.blade.php ENDPATH**/ ?>