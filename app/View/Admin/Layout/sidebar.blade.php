    ...
    <div class="sidebar bg-light shadow">
        ...
        <div class="sidebar-body">
            <ul class="navigation-list">
                <li class="navigation-list-item {{$model['dashboard'] ?? ''}}">
                ...
                <li class="navigation-list-item {{$model['supply'] ?? ''}}">
                ...
                <li class="navigation-list-item">
                    <a href="/admin/laporan" class="navigation-link {{$model['laporan'] ?? ''}}">
                        <div class="row p-1 px-3 mb-2">
                            <div class="col-2">
                ...
                <li class="navigation-list-item">
                    <a href="/admin/item" class="navigation-link {{$model['listItem'] ?? ''}}">
                        <div class="row p-1 px-3 mb-2">
                            <div class="col-2">
                ...
                <li class="navigation-list-item">
                    <a href="/admin/schedule" class="navigation-link {{$model['listItem'] ?? ''}}">
                        <div class="row p-1 px-3 mb-2">
                            <div class="col-2">
                                <i class="fa-solid fa-list"></i>
                            </div>
                        ...
                        <div class="flex-shrink-0 dropdown">
                            <a aria-expanded="false" class="d-block link-dark text-decoration-none dropdown-toggle"
                               data-bs-toggle="dropdown" href="#">
                                <div class="avatar"
                                     data-label="{{$model['fullName'] ?? 'HA'}}"></div>
                            </a>
